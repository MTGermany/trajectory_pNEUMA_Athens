...
set style line 1 lt 1 lw 4 pt 7 ps 1.9 dt 1 lc rgb "#000000" #schwarz, bullet
...
set style line 6 lt 1 lw 4 pt 4 ps 1.5 dt 1 lc rgb "#5555FF"
...
#############################################
# laneRef=2; lanePlot=2; set xrange [190:350]  # left w/o motorcycles
...
epsfile=sprintf("%s_road%i_lane%i_xt_book.eps", proj, laneRef, lanePlot)
str_lanePlotAll=sprintf("Lane %i, cars/trucks",lanePlot)
