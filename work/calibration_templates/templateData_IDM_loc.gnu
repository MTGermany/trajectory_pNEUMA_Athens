...
set style line 4 lt 6 lw 4 pt 4 ps 1.5  lc rgb "#FFAA00" 
...
set term post eps enhanced color dash "Helvetica" 22

#######################################################
set out str_tseries_a
print "plotting ".str_tseries_a
#######################################################
...
plot\
  str_proj.".out" u 1:($5) t str_data w l ls 2,\
